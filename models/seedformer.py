...
from models.utils import Self_Attn, Self_RelAttn, vTransformer, PointNet_SA_Module_KNN, MLP_Res, MLP_CONV, fps_subsample, query_knn, grouping_operation, get_nearest_index, indexing_neighbor
...
class FeatureExtractor(nn.Module):
    ...
    def forward(self, partial_cloud):
        ...
        batch_size, _, _ = partial_cloud.size()
        ...
        # partial_cloud = partial_cloud.reshape(-1, 3, 2048)
        # pc1_xyz, pc2_xyz, pc3_xyz = self.netG(partial_cloud)
        # print("111", pc1_xyz.shape)
        # print("222", pc2_xyz.shape)
        # print("333", pc3_xyz.shape)
        # print("aaa", l3_points.view(batch_size, -1).shape)
        # print("bbb", l2_xyz.shape)
        # print("ccc", l2_points.shape)

        return l3_points.view(batch_size, -1), l2_xyz, l2_points   #(B, 1024), (B, 3, 128), (B, 256, 128)


class SeedGenerator(nn.Module):
    def __init__(self, feat_dim=1024, seed_dim=128, n_knn=16, factor=2, attn_channel=True):
        ...
        self.mlp_2 = Self_Attn(in_dim=128)
    ...
    def forward(self, feat, patch_xyz, patch_feat):
        ...
        # print("666", x1.size())
        # print("777", feat.repeat((1, 1, x1.size(2))).size())
        # print("888", feat.size())
